...
%\begin{enumerate} 
\item%  On a relevé dans le tableau ci-dessous les points obtenus par Rémi et Nadia lors de sept parties de fléchettes. Le résultat de Nadia lors la partie 6 a été égaré.
...
Soit $x$ le nombre de points par Nadia à la 6\up{e} partie. 
