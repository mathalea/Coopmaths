...
\begin{enumerate}
\item \textit{Comme le dé est équilibré, la probabilité d'obtenir un \og 1 \fg{} est la même que celle d'obtenir un \og 5 \fg{} est de $\dfrac{1}{6}$.} 
...
\textit{Pour une issue rouge, il y a 6 issues jaunes. Comme il y a 6 issues rouges , le nombre d'issues possibles quand il lance ses deux dés est de \fbox{$6\times 6= 36$}.}
...
\textit{Il ne lui reste qu'à obtenir 350 points pour gagner la partie, soit à obtenir 400, 500, 600 ou 1000 points, c'est-à-dire une paire de 4, de 5, de 6, ou de 1. La probabilité de chaque paire étant de $\dfrac{1}{36}$,  la probabilité qu'il gagne la partie à son troisième lancer est de $\dfrac{4}{36}$ soit \fbox{$\dfrac{1}{9}$}.}
