...
%			&Nombre de voitures 
%en circulation (en milliers)	& Parcours moyen annuel
...
Il y avait en 2014 $\np{19741} + \np{11984} = \np{31725}$ milliers de voitures soit \np{31725000} voitures \og \emph{diesel ou essence}\fg{}
...
Comme $7 \times \np{15000} = \np{105000}$, le présentateur pense qu'il fait partie des conducteurs qui font en moyenne 15000 par an donc des possesseurs de véhicules diesel.
		...
		\np{8344} est la moyenne parcourue par un possesseur de véhicule essence mais rien n'interdit à Hugo d'avoir parcouru beaucoup plus de kilomètres.
	\end{enumerate}
 \end{enumerate}
